...
O uso de uma interface x4 diminuiria o tempo de programação em 4 vezes, o que não é fator crítico para este experimento.
...
A única diferença são os arquivos adicionados, que agora 
