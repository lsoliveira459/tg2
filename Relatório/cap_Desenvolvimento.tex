...
\subsection{Leitor de Cartão de Memória SD}
...
Uma solução é a implementação de um sistema que carregue as informações de uma memória não-volátil para a memória DDR3 em um momento inicial, e depois permita que a memória DDR3 seja acessada para a reconfiguração dinâmica.
...
O \textit{bootloader}, como mencionado acima, é um sistema que carregará as informações de uma memória lenta, a QSPI Flash foi escolhida, para uma memória rápida.
