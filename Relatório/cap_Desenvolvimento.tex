...
O próximo passo natural no desenvolvimento deste projeto é a tentativa de autorreconfiguração através do MicroBlaze.

\section{Experimento 4 - Teste da Autoreconfiguração com \textit{MicroBlaze}}
Neste experimento espera-se conseguir projetar e implementar um sistema baseado em MicroBlaze que se reconfigure de forma autônoma.
Para isto, deve-se entender o processo de cria
