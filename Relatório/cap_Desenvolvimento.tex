...
Como todos os arquivos binários prontos, pode-se começar o processo de programação indireta da memória Flash como descrito na seção \ref{sec:flash_indireta}.
Este processo começa criando-se um arquivo de memória PROM através da ferramenta iMPACT.
Vale salientar apenas que, como mencionado anteriormente, faz-se necessário que todos os elementos sejam previamente compilados para uma mesma interface SPI.
