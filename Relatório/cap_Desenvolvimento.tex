...
9 bytes (0x00 09) & 0x0f f0 0f f0 0f f0 0f f0 00 & Indica que a configuração a seguir é válida. \\ \hline
1 byte (0x00 01) & "a" (0x61) & Indica que os próximos campos conterão informações sobre o projeto e sobre a configuração. \\ \hline
35 bytes (0x00 23) & [Chave muito longa] & Apresenta o nome do \textit{netlist} e o identificador do usuário. 0x00 ao final indica o final da string. \\ \hline
& "b" (0x62) & Indica que o próximo campo é um indentificador do dispositivo-alvo. \\ \hline
13 bytes (0x00 0d) & 7k325tffg900 & Identificador do dispositivo-alvo. 0x00 ao final indica o final da string. \\ \hline
& "c" (0x63) & Indica que o próximo campo é a data de sintese da configuração. \\ \hline
11 bytes (0x00 0b) & 2013/11/26 & Data da síntese da configuração. \\ \hline
& "d" (0x64) & Indica que o próximo campo é a hora de síntese da configuração. \\ \hline
9 bytes (0x00 09) & 08:54:11 & Hora de síntese da configuração. \\ \hline
& "e" (0x65) & Indica que os próximos 8 bytes contém o tamanho da configuração. \\ \hline
& 661188 bytes (0x00 0a 16 c4) & Tamanho da configuração a partir desta posição. \\\hline
\end{tabular}
...
\subsubsection{Inicialização da Memória SPI Flash}
...
Apesar disto, programar a FPGA utilizando apenas a SPI Flash pode ser muito custoso \cite{xapp586}.
Este processo demora em torno de 1 minuto e 30 segundos, em condições ideais.
