...
\begin{figure}[htp]
\centering
\includegraphics[height=100px]{fig/c3_desenvolvimento/ex3/softwareflow.pdf}
...
A figura \ref{fig:ex3:softwareflow} apresenta o fluxo de ferramentas para este caso específico.
...
Tanto o programa quando o processador gerarão arquivos binários que serão carregados pelo iMPACT.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{fig/c3_desenvolvimento/ex3/MicroBlaze_Core.pdf}
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.8\textwidth]{fig/c3_desenvolvimento/ex3/XPS.pdf}
\caption{Imagem do XPS logo que aberto.}
\label{fig:ex3:xps}
\end{figure}
\begin{figure}[htp]
\centering
\includegraphics[width=0.75\textwidth]{fig/c3_desenvolvimento/ex3/BSB_AXI_flow.pdf}
\caption{Escolha dos periféricos no BSB do XPS.}
\label{fig:ex3:bsb_prerifericos}
\end{figure}

Para começar, deve-se abrir o programa e criar um novo projeto usando o \textit{Base System Builder} (BSB), opção que corresponde ao item superior esquerdo do menu da figura \ref{fig:ex3:xps}.
Na janela que aparece, escolheu-se a placa de desenvolvimento que se escolheu utilizar e a opção de um só processador no sistema, para simplificar o projeto.
Dando prosseguimento, escolheu-se os periféricos desejados segundo a figura \ref{fig:ex3:bsb_prerifericos} e o tamanho das memórias local, de intrução e de dados, quiça 64 KB.

\begin{figure}[htp]
\centering
\includegraphics[width=439px]{fig/c3_desenvolvimento/ex3/xps_address.pdf}
\caption{Aba \textit{Addresses} do \textit{System Assembly View} indicando os ajustes dos endereços e tamanhos das memórias.}
\label{fig:ex3:xps_enderecos}
\end{figure}
...
Muda-se então o tamanho da memória SPI Flash para 128M, seu endereço base para 0x70000000, o tamanho da memória DDR3 para 1G e seu endereço base para 0xC0000000, conforme a figura \ref{fig:ex3:xps_enderecos}.
Note que o endereço da memória SPI Flash pode ser alterado, tendo como única restrição de ter os 28 bits menos significativos iguais a zero.
O endereço base da memória DDR3, porém, não pode ser alterado visto que o endereço de 0xC0000000 a 00xC7FFFFFF é utilizado como memória \textit{cache} pela interface AXI4.
...
Seleciona-se a pasta SDK, criada dentro da pasta do projeto do sistema durante sua exportação.
