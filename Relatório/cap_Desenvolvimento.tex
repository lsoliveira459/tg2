...
Usou-se um microcontrolador MicroBlaze com controladores para a memória QSPI Flash, DDR3 e GPIO, que dá acesso aos pinos da placa.
...
\begin{figure}[h]
\centering
\includegraphics[height=100px]{figs/ex3/softwareflow}
\caption{Foto ilustrativa do fluxo de ferramentas para o desenvolvimento de sistemas com MicroBlaze.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figs/ex3/XPS}
