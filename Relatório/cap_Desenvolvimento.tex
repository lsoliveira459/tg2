...
Ainda no cabeçalho, tem-se um 32 bites de espaçamento preenchidos por com \dlq{}0xff\drq{}.
Em seguida, tem-se os bites para autodetecção de largura de banda \cite{ug470, xapp583}.
Estes bites (\dlq{}0x00 00 00 bb 11 22 00 44\drq{}) são usados no modo de configuração paralelo para detectar automaticamente a largura de banda do arquivo de configuração.
...
9 bites (0x00 09) & 0x0f f0 0f f0 0f f0 0f f0 00 & Indica que a configuração a seguir é válida. \\ \hline
1 bite (0x00 01) & "a" (0x61) & Indica que os próximos campos conterão informações sobre o projeto e sobre a configuração. \\ \hline
35 bites (0x00 23) & [Chave muito longa] & Apresenta o nome do \textit{netlist} e o identificador do usuário. 0x00 ao final indica o final da string. \\ \hline
& "b" (0x62) & Indica que o próximo campo é um indentificador do dispositivo-alvo. \\ \hline
13 bites (0x00 0d) & 7k325tffg900 & Identificador do dispositivo-alvo. 0x00 ao final indica o final da string. \\ \hline
& "c" (0x63) & Indica que o próximo campo é a data de sintese da configuração. \\ \hline
11 bites (0x00 0b) & 2013/11/26 & Data da síntese da configuração. \\ \hline
& "d" (0x64) & Indica que o próximo campo é a hora de síntese da configuração. \\ \hline
9 bites (0x00 09) & 08:54:11 & Hora de síntese da configuração. \\ \hline
& "e" (0x65) & Indica que os próximos 8 bites contém o tamanho da configuração. \\ \hline
& 661188 bites (0x00 0a 16 c4) & Tamanho da configuração a partir desta posição. \\\hline
\end{tabular}
...
\paragraph{Troca de bites} A interface ICAP e a ICAPE2, similares a interface SelectMAP \cite{wp374}, precisa de uma inversão na ordem dos bits nos bites da configuração, incluindo a palavra de sincronia \cite{xapp502}.
Esta inversão é necessária apenas no uso destas três interfaces.
Note que alguns tipos de arquivos sintetisados, como o MCS e o HEX, já podem ter estes bites invertidosnão sendo necessário invertê-los novamente \cite{ug470}.
