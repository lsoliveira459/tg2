...
\begin{figure}[htp]
\centering
\includegraphics[width=0.8\textwidth]{fig/c3_desenvolvimento/ex2/XPS.pdf}
\caption{Imagem do XPS logo que aberto.}
\label{fig:ex2:xps}
\end{figure}

Para começar, deve-se abrir o programa e criar um novo projeto usando o \textit{Base System Builder} (BSB), opção que corresponde ao item superior esquerdo do menu da figura \ref{fig:ex2:xps}.
...
\begin{figure}[htp]
\centering
\includegraphics[width=439px]{fig/c3_desenvolvimento/ex2/xps_address.pdf}
...
Muda-se então o tamanho da memória SPI Flash para 128M, seu endereço base para 0x70000000, o tamanho da memória DDR3 para 1G e seu endereço base para 0xC0000000, conforme a figura \ref{fig:ex2:xps_enderecos}.
