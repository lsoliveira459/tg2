...
Note que pode ser necessária a criação de um projeto para interfaceamento entre os elementos externos da placa utilizados pelas partições reconfiguráveis, uma vez que, como mencionado no experimento 1, não é recomendado conectar módulos reconfiguráveis diretamente a pinos de entrada e saída.

\subsubsection{XPS}

%\subsubsection{Registrador de \textit{Status}} Este registrador, acessado através de uma sequência predefinida de comandos pela interface ICAPE2 \cite{ug470 - pp108}, informa 

\subsection{Possiveis Erros}
