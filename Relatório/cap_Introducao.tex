...
Ela possui uma sintaxe similar a linguagem \dlq{}Ada\drq{}.
...
Ela \'e basicamente um conjunto de classes e macros para \dlq{}C++\drq{} que disponibiliza uma interface de simula\c{c}\~ao dirigidas por eventos.
...
Uma vez que n\~ao foi desenvolvida com o prop\'osito principal de descric\~ao de \text{hardware}, possui um chamado \dlq{}\textit{overhead} sint\'atico\drq{} com rela\c{c}\~ao a Verilog e VHDL, onde mais texto tem que ser escrito para descrever um mesmo comportamento.
...
\section{Objetivo}
\label{sec:projeto}
O projeto desenvolvido aqui tem por objetivo o estudo de autoreconfiguração parcial, incluindo as ferramentas e periféricos necessários para tal.
