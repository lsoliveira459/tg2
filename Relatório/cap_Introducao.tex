...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{figs/moores_law}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{figs/history_risc}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{figs/model_f+v}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{figs/model_pal}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{figs/model_cpld}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{figs/model_fpga}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{figs/model_rdpa}
...
\todo{Me prolongar mais em reconfiguração dinâmica (Hauck2007 p.70)}
...
\todo{Diferenciar autoreconfiguração de reconfiguração externa.}
\todo{Incluir figura sobre autoreconfiguraçao do manual da Xilinx (ver Evernote).}
