...
\todo{Descrever o fluxo de "compilação" de um projeto de hardware para FPGA.}

Note que a avaliação de desempenho de sistemas reconfiguráveis não pode mais ser dada com base em quantidade de operações em ponto flutuante (FLOPS) como é feita em computadores e similares \cite{patterson2005coa, cullinan2012computing}.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{fig/c1_introducao/fluxo.pdf}
\caption{Imagem ilustrativa do fluxo de síntese de um projeto de \textit{hardware}.}
\label{fig:fluxo}
\end{figure}
